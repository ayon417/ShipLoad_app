...
class EditAddressView extends ConsumerStatefulWidget {
  final Datum? data;
  const EditAddressView({super.key, this.data});

  @override
  ConsumerState<EditAddressView> createState() => _EditAddressViewState();
}
          ...
          child: CustomLoadingButton(
            ...
            onTap: () async {
              if (formKey.currentState!.validate()) {
                ...
                isLoading = true;
                setState(() {});
                await _viewModel.editShippingAddress(
