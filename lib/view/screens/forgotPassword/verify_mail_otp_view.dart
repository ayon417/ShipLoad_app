...
class VerifyMailOtpView extends ConsumerStatefulWidget {
  const VerifyMailOtpView({super.key});

  @override
  ConsumerState<VerifyMailOtpView> createState() => _VerifyMailOtpViewState();
}

class _VerifyMailOtpViewState extends ConsumerState<VerifyMailOtpView>
    with BaseScreenView {
                  ...
                  children: [
                    ...
                    CustomLoadingButton(
                      ...
                      onTap: () async {
                        isLoading = true;
                        setState(() {});
                        await _viewModel.emailVerifyOtp(
                          EmailVerifyOtpRequest(otp: otpController.text),
                          context,
