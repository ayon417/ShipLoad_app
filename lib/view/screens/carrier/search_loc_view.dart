...
class SearchLocationView extends ConsumerStatefulWidget {
  const SearchLocationView({Key? key}) : super(key: key);

  @override
  ConsumerState<SearchLocationView> createState() => _SearchLocationViewState();
}

class _SearchLocationViewState extends ConsumerState<SearchLocationView>
    with BaseScreenView {
            ...
            onSuggestionSelected: (suggestion) async {
              ...
              if (detailsResponse.statusCode == 200) {
                ...
                if (detailsData['status'] == 'OK') {
                  ...
                  _draggedAddress = suggestion['description'];
                  setState(() {});
                }
              }
            },
        ...
        children: [
          ...
          CustomLoadingButton(
            ...
            onTap: () async {
              ...
              _viewModel.pickupLocationName = _draggedAddress;
              _viewModel.pickupLocation = [long, lat];
